...
// Homepage content groups used for the solution primer and digital service section.
export const solutionChips = ['企业接待', '客户答谢', '节庆礼赠', '签约宴请', '企业定制', '品鉴会'];

export const digitalServiceSteps = ['需求确认', '方案设计', '样品确认', '包装制作', '交付回访'];

export const digitalServiceWidgets = [
  { icon: 'users', label: '客户档案', value: '偏好 / 周期 / 复购' },
  { icon: 'qrCode', label: '扫码选品', value: '到店快速了解' },
  { icon: 'clipboardList', label: '需求表单', value: '预算数量标准化' },
  { icon: 'calendarClock', label: '复购提醒', value: '节庆节点跟进' },
];
